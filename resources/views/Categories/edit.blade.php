            ...
            <form method="POST" action="{{ route('updatecategory',['id'=>$category->id]) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-2">
                        ...
                        <input required class="form-control @error('category_name') is-invalid @enderror"
                            name="category_name" value="{{$category->category_name}}" type="text" id="category_name" placeholder="Enter category name"
                            maxlength="50">
                        @error('category_name')
                    ...
                    <div class="col-md-6 form-group mb-2">
                        ...
                        <input class="form-control @error('category_subtitle') is-invalid @enderror"
                          value="{{$category->short_description}}"  name="category_subtitle" type="text" placeholder="Enter sub title for category"
                            maxlength="100">
                    ...
                    <div class="col-md-12 imagecontainer">
                        <img id="image" src="{{ url($category->category_image) }}" alt="">
                    </div>
                </div>
