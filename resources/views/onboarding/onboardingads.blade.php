        ...
        <table class="table" id="datatabel">
            ...
            <tbody>
                @foreach ($ads as $ad)
                    <tr>
                        <td>{{ $ad->id }}</td>
                        <td scope="row"><img class="tableimg" src="{{ $ad->image_url }}" alt=""></td>
                        <td>{{ $ad->title }}</td>
                        <td>{{ $ad->subtitle }}</td>
                        <td> 
                            <label class="switch">
                        ...
                        <td>
                            <div class="button-container">
                                <a href="{{ route('categoryupdatepage', ['id' => $ad->id]) }}" class="btn btn-info"><img
                                        src="{{ asset('assets/imgs/icons/edit.png') }}" alt=""></a>
                                <a href="{{ route('categoryupdatepage', ['id' => $ad->id]) }}" class="btn btn-danger"><img
                                        src="{{ asset('assets/imgs/icons/bin.png') }}" alt=""></a>
                            </div>
                        </td>
                    </tr>
                @endforeach
