...
@section('main')
    <div class="container">
        <div class="top-heading px-1 py-2 d-flex">
            <div class="part1">
                <h1>Professional</h1>
                <p>On this screen, you can Update Professional.</p>
            </div>
            <div class="part2">
            </div>
        </div>
        <div class="container mt-5">
            <div class="form-div">
                ...
                <form action="{{ route('updateprofessionl', ['id' => $professional->id]) }}" id="form" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <h2 class="mb-4 text-center">Update Professional Details</h2>
                    <div id="coverimage" style="background-image: url('{{ asset($professional->cover_image_url) }}') "
                        class="coverimage">
                        <div class="coverpicinput" onclick="openimagesbg()">
                            <img src="{{ asset('assets/imgs/icons/pen.png') }}" alt="">
                        </div>
                    </div>
                    <div id="profilepic" style="background-image: url('{{ asset($professional->logo_url) }}') "
                        class="profilepic">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input required class="form-control @error('name') is-invalid @enderror" name="name"
                                type="text" id="name" value="{{ $professional->name }}"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input required class="form-control @error('username') is-invalid @enderror" name="username"
                                id="username" type="text" value="{{ $professional->username }}"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input required class="form-control @error('email') is-invalid @enderror" name="email"
                                type="email" id="email" value="{{ $professional->email }}"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <div>
                                <input required class="form-control @error('phone_num') is-invalid @enderror"
                                    name="phone_num" type="tel" value="{{ $professional->phone_number }}"
                                    id="phone_num" placeholder="Enter phone number" maxlength="15">
                                @error('phone_num')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <select onchange="getstates()" required
                                ...
                                id="country_id">
                                <option value="{{ $professional->country->id }}" selected>
                                    {{ $professional->country->country_name }}</option>

                                @foreach ($country as $data)
                                    @if ($data->id != $professional->country->id)
                                        <!-- Skip the already selected country -->
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <select onchange="getcities()" required
                                ...
                                id="state_id">
                                <option value="{{ $professional->state->id }}"  selected>
                                    {{ $professional->state->state_name }}</option>

                                @foreach ($sates as $data)
                                    @if ($data->id !== $professional->state->id)
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <select required class="form-control @error('city_id') is-invalid @enderror" name="city_id"
                                id="city_id">
                                <option value="{{ $professional->city->id }}" selected>
                                    {{ $professional->city->city_name }}</option>


                                @foreach ($cities as $data)
                                    @if ($data->id !== $professional->city->id)
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input required class="form-control @error('address') is-invalid @enderror" name="address"
                                id="address" type="text" value="{{ $professional->address }}"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input id="latitude" value="{{ $professional->latitude }}" name="latitude"
                                class="form-control" type="text" readonly>
                        </div>
                        {{-- longitude --}}
                        <div class="col-md-6 form-group mb-4">
                            <label class="form-label" for="longitude">Longitude</label>
                            <input id="longitude" value="{{ $professional->logitude }}" name="longitude"
                                class="form-control" type="text" readonly>
                        </div>
                        {{-- area name --}}
                        <div class="col-md-6 form-group mb-4">
                            <label class="form-label" for="area">Area name</label>
                            <input id="area" name="area" value="{{ $professional->area_name }}"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input type="number" class="form-control" id="working_range" name="working_range"
                                min="1" max="15" value="{{ $professional->working_range }}" step="1"
                                placeholder="Enter working range in km">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <select required class="form-control @error('category_id') is-invalid @enderror"
                                ...
                                <option value="{{ $professional->category->id }}" selected>
                                    {{ $professional->category->category_name }}</option>

                                @foreach ($categories as $data)
                                    @if ($data->id != $professional->category->id)
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <select required class="form-control @error('bussnies_type') is-invalid @enderror"
                                ...
                                <option value="{{ $professional->business_type }}" selected>
                                    {{ $professional->business_type }}</option>

                                @if ($professional->business_type != 'on_site')
                                    <option value="on_site">On-site</option>
                                @endif

                                @if ($professional->business_type != 'home_service')
                                    <option value="home_service">Home Service Only</option>
                                @endif

                                @if ($professional->business_type != 'both')
                        ...
                        <div class="col-md-6 form-group mb-4">
                            <label class="form-label" for="working_hours_start">Working Hours <Details: class="lead">
                                    (Start)</Details:></label>
                            <input required value="{{ $professional->working_time_start }}"
                                class="form-control @error('working_hours_start') is-invalid @enderror" type="time"
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input required value="{{ $professional->working_time_end }}"
                                class="form-control @error('working_hours_end') is-invalid @enderror" type="time"
                        ...
                        <div class="col-md-12 form-group mb-4">
                            ...
                            <div>
                                @php
                                    // Convert the working days string into an array for easier processing
                                    $workingDays = explode(',', $professional->working_days);
                                @endphp

                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="monday" name="working_days[]"
                                        value="Monday" {{ in_array('Monday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="monday">Monday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="tuesday" name="working_days[]"
                                        value="Tuesday" {{ in_array('Tuesday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="tuesday">Tuesday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="wednesday" name="working_days[]"
                                        value="Wednesday" {{ in_array('Wednesday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="wednesday">Wednesday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="thursday" name="working_days[]"
                                        value="Thursday" {{ in_array('Thursday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="thursday">Thursday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="friday" name="working_days[]"
                                        value="Friday" {{ in_array('Friday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="friday">Friday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="saturday" name="working_days[]"
                                        value="Saturday" {{ in_array('Saturday', $workingDays) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="saturday">Saturday</label>
                                </div>
                                <div class="form-check d-inline-block me-3">
                                    <input class="form-check-input" type="checkbox" id="sunday" name="working_days[]"
                                        value="Sunday" {{ in_array('Sunday', $workingDays) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 form-group mb-4">
                            ...
                            <textarea class="form-control" name="description" id="" rows="3">P{{ $professional->description }}</textarea>
